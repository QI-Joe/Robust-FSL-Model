...
from GCA_functional import pr_drop_weights, evc_drop_weights, feature_drop_weights_dense, feature_drop_weights, get_activation,\
compute_pr, degree_drop_weights, generate_split, get_base_model, eigenvector_centrality, SimpleParam

import networkx as nx

def GCA_Augmentation(data: Data, param: SimpleParam, args, device: torch.device, *kargs)->tuple[torch.Tensor, torch.Tensor]:
